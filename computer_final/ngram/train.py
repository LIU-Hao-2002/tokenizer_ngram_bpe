...
class TrainNgram():
    ...
    def train(self, train_data_path, wordict_path, transdict_path):
        ...
        for sentence in open(train_data_path,encoding='utf-8'):
...
if __name__ == '__main__':
    train_data_path = r'/root/computer_final/round2_data_train.txt'
    wordict_path = r'./model/word_dict_2.model'
    transdict_path = r'./model/trans_dict_2.model'
    trainer = TrainNgram()
